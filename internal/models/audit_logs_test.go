...
var (
	auditLogDBTypes = map[string]string{`ID`: `bigint`, `Timestamp`: `timestamp with time zone`, `EventType`: `character varying`, `UserID`: `character varying`, `KeyID`: `character varying`, `NodeID`: `character varying`, `SessionID`: `character varying`, `Operation`: `character varying`, `Result`: `character varying`, `Details`: `jsonb`, `IPAddress`: `character varying`}
	_               = bytes.MinRead
)
